                ...
                <div className="firstPanel">
                    <div className="experement">
                        ...
                        <div className="experementActions">
                            ...
                            >
                                <path
                                    d="M3.61542 4.71429H15.3847V3.85714H3.61542V4.71429Z"
                                    fill="black"
                                />
                                <path
                                    d="M3.61542 9H15.3847V8.14286H3.61542V9Z"
                                    fill="black"
                                />
                                <path
                                    d="M3.61542 13.2857H15.3847V12.4286H3.61542V13.2857Z"
                                    fill="black"
                                />
                                <path
                                    fillRule="evenodd"
                ...
                <div className="lastPanel">
                    ...
                    {!isCalibrationEnd &&
                        <button
                            ...
                            disabled={isCalibration || isStart}
                        >
                    ...
                    <button className="actionBtn" disabled={!isStart}>Завершить</button>
                </div>
            </div>
        </>
    );
